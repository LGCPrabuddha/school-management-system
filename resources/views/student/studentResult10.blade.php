...
<script>
    ...
    type: 'bar',
    data: {
      labels: ["Religion", "Sinhala", "Maths","Seince","English","History","Group 1","Group 2","Group 3"],
      datasets: [
        {
          label: "1st Term",
          ...
          data:  [<?php echo ($examResults[9]) ?>,<?php echo ($examResults[10]) ?>, <?php echo ($examResults[11]) ?>,
                  <?php echo ($examResults[12]) ?>,<?php echo ($examResults[13]) ?>,<?php echo ($examResults[14]) ?>,
                  <?php echo ($examResults[15]) ?>,<?php echo ($examResults[16]) ?>,<?php echo ($examResults[17]) ?>]
        }, {
          label: "3rd Term",
          backgroundColor: "#bccad6",
          data:  [<?php echo ($examResults[18]) ?>,<?php echo ($examResults[19]) ?>, <?php echo ($examResults[20]) ?>,
                  <?php echo ($examResults[21]) ?>,<?php echo ($examResults[22]) ?>,<?php echo ($examResults[23]) ?>,
                  <?php echo ($examResults[24]) ?>,<?php echo ($examResults[25]) ?>,<?php echo ($examResults[26]) ?>]
        }
      ]
    },
    options: {
