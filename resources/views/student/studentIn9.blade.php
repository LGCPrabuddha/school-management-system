       ...
       <div id="wrapper">
          ...
          <div id="sidebar-wrapper">
              <ul class="sidebar-nav" style="margin-left:0;">
                  ...
                  <li class="iconfont">
                      <a href="{{route('viewStudentOLResult')}}"> <i class="fa fa-list-alt " aria-hidden="true"> </i> <span style="margin-left:10px;"> O/L Results</span> </a>
                  </li>
                  <li class="iconfont">
                      <a href="{{route('viewStudentResult')}}"> <i class="fa fa-graduation-cap" aria-hidden="true"> </i> <span style="margin-left:10px;"> Student Results</span> </a>
                  </li>
              </ul>
          </div>
