...
class AdminController extends Controller
{
    ...
    public function studentReg(Request $request)
    {
      ...
      $table->fname	          =$request->input('fullName');
      ...
      $table2->fNIC        =$request->input('fathNIC');
      $table2->fOld        =$request->input('fatOld');
      ...
      $table2->mNIC        =$request->input('mothNIC');
      $table2->mOld        =$request->input('mothOld');
      ...
      $table3->gNIC        =$request->input('guaNIC');
      $table3->gOld        =$request->input('guaOld');
    ...
    public function userDitels(Request $request)
    {
      ...
      $this->validate($request, [
        ...
        'Detail' => 'required',
          ...
          'Detail.required' => 'Select the category.',
    		]);

      if ($request->input('poshition')=='Student') {
        $detail = "Student";
        //student ditels
        if ($request->input('Detail')=='Personal') {
          ...
          return view('admin/showUserMain')->with('message','Please choose the category');
        }
